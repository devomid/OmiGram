  ...
  return (
    <Box>
      <Stack spacing={3}>
        ...
        <FormControl error={errors.email && touched.email ? true : false} fullWidth >
          <Input type='text' id='email' name='email' value={values.email} onChange={handleChange} onBlur={handleBlur} sx={{ backgroundColor: 'rgba(255, 255, 255, 0.2)', backdropFilter: 'blur(20px) saturate(180%)' }} error={errors.email && touched.email ? 'true' : false} required placeholder="Email" />
          <FormHelperText sx={{ height: '1rem' }}>{errors.email && touched.email ? errors.email : (' ')}</FormHelperText>
        </FormControl>

        <FormControl error={errors.phoneNumber && touched.phoneNumber ? true : false} fullWidth sx={{ mb: 6 }}>
          <Input type='tel' id='phoneNumber' name='phoneNumber' value={values.phoneNumber} onChange={handleChange} onBlur={handleBlur} sx={{ backgroundColor: 'rgba(255, 255, 255, 0.2)', backdropFilter: 'blur(20px) saturate(180%)' }} placeholder="Phone Number" />
